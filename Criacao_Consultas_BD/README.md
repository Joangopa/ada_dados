...
Para facilidade, o arquivo sql gerador da base encontrase nesta pasta com o nome classicmodels_DB.sql 
...
No arquivo ComandosDDL.sql [https://github.com/Joangopa/ada_dados/blob/main/Criacao_Consultas_BD/ComandosDDL.sql] encontra-se os comandos para a criação do Banco de Dados, assim como algusn outros comandos DDL para criação de tabelas, modificação estrutural de tabelas e remoção de tabelas.
 ...
 ComandoDML_Basico.sql encontra-se comandos de inserção, edição e remoção de dados nas tabelas